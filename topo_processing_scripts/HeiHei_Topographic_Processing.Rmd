...
#channel 
channelR=raster("river_mask_edit3.tif")
...
image.plot(area,main="drainage Area", zlim=c(0,300))
...
travHS smae - we never turn cells in a different direction but we do change elevation (rivSmooth)
my simulations really sensitive to minslope because domain is so flat

1. make a grpah of the slopes coming out of this step
