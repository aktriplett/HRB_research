...
#-----------------------------------------------------------------------------
set runname "troubleshoot_HRB_parkinglot6"
#file mkdir $runname
#cd $runname
...
#pfset GeomInput.domaininput.FileName            "HRB_domain_solid_test.pfsol"
pfset GeomInput.domaininput.FileName            "HRB_domain_init_solid_test.pfsol"
...
#pfset Patch.top.BCPressure.alltime.Value	               -0.05
#pfset Patch.top.BCPressure.alltime.Value	                0.00000
