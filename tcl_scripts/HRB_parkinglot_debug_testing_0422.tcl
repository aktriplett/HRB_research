...
#-----------------------------------------------------------------------------
set runname "troubleshoot_HRB_parkinglot8"
file mkdir $runname
cd $runname
...
pfset GeomInput.domaininput.FileName            "../parflow_input/HRB_domain_solid_test.pfsol"

pfset Geom.domain.Patches                       "sides bottom top"
