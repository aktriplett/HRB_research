...
file mkdir $runname
cd $runname
pfset TopoSlopes.Elevation.FileName ../parflow_input/HRB.dem.pfb
#Where does it bring us to the correct directory? I don't see a place where it Navigates to LW exercise folder

#-----------------------------------------------------------------------------
# Set Processor topology
#-----------------------------------------------------------------------------
pfset Process.Topology.P 1 #this will need to change when running on Cheyenne
...
pfset ComputationalGrid.DZ                600.0 #Not sure what this value should be
...
#-----------------------------------------------------------------------------
pfset GeomInput.Names                     "box_input" #this is still a box right?
...
pfset Geom.domain.Upper.Z                        1072.0 #lowest depth? Need for parking lot?
...
pfset Solver.Nonlinear.VariableDz                     False #set true for vardz
